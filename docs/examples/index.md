...
|---------|-------------|----------|------|------------|
| **Logistic Regression** | Binary outcome prediction (mortality, readmission) | [📥 `.ipynb`](https://github.com/noispuc/isaric3.0-rapid/raw/restructure/docs/examples/logistic_example.ipynb){:target="_blank"} | [👁️ View](logistic_example.ipynb) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noispuc/isaric3.0-rapid/blob/restructure/docs/examples/logistic_example.ipynb){:target="_blank"} |
| **GLM** | Generalized Linear Models with different families | [📥 `.ipynb`](https://github.com/noispuc/isaric3.0-rapid/raw/restructure/docs/examples/glm_example.ipynb){:target="_blank"} | [👁️ View](glm_example.ipynb) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noispuc/isaric3.0-rapid/blob/restructure/docs/examples/glm_example.ipynb){:target="_blank"} |
| **Survival Analysis** | Time-to-event analysis with Cox PH | [📥 `.ipynb`](https://github.com/noispuc/isaric3.0-rapid/raw/restructure/docs/examples/survival_example.ipynb){:target="_blank"} | [👁️ View](survival_example.ipynb) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noispuc/isaric3.0-rapid/blob/restructure/docs/examples/survival_example.ipynb){:target="_blank"} |
| **MICE Imputation** | Multiple imputation for missing data | [📥 `.ipynb`](https://github.com/noispuc/isaric3.0-rapid/raw/restructure/docs/examples/mice_example.ipynb){:target="_blank"} | [👁️ View](mice_example.ipynb) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/noispuc/isaric3.0-rapid/blob/restructure/docs/examples/mice_example.ipynb){:target="_blank"} |
